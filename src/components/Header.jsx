    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
      <div className="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          ...
          {/* User Info (Vertical Layout) */}
          <div className="flex items-center gap-3 pl-6 border-l border-slate-200">
             <div className="text-right hidden md:block">
                <p className="text-sm font-bold text-slate-700 leading-tight">Test User</p>
                <p className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Premium Member</p>
             </div>
             <FaUserCircle className="text-3xl text-slate-300" />
          </div>

          {/* Logout Button (Small & Sleek) */}
          <button 
